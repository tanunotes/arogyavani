...
const translations = {
  en: {
    ...
    caregiverBtn: "👨‍⚕️ Caregiver / Family",
    patientBtn: "🤒 Patient",
    caregiverInfo:
  ...
  hi: {
    ...
    caregiverBtn: "👨‍⚕️ देखभालकर्ता / परिवार",
    patientBtn: "🤒 रोगी",
...
// Initialize on page load...waits till page loads
